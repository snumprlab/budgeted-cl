...
# CIL CONFIG
NOTE="clib_1r" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="clib"
...
do
    python main.py --mode $MODE --data_dir ../ILSVRC/Data/CLS-LOC \
    --dataset $DATASET  \
