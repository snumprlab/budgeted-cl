...
# CIL CONFIG
NOTE="ours_10_4_50" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="ours_v11"
...
do
    ...
    --memory_size $MEM_SIZE $GPU_TRANSFORM --online_iter $ONLINE_ITER --ema_ratio $EMA_RATIO \
    --note $NOTE --eval_period $EVAL_PERIOD $USE_AMP --beta $BETA --importance $IMPORTANCE $REDUCE_BP &
done
