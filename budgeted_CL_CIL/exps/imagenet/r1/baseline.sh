...
# CIL CONFIG
NOTE="baseline_10_4_50" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="ours"
...
do
    ...
    --note $NOTE --eval_period $EVAL_PERIOD $USE_AMP --beta $BETA $FEATURE_ONLY &
done
