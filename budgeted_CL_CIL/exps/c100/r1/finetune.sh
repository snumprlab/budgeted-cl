...
# CIL CONFIG
NOTE="ft_10_1" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="er"
...
do
    ...
    --lr $LR --batchsize $BATCHSIZE --temp_batchsize $BATCHSIZE\
