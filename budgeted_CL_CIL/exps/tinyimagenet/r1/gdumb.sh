...
# CIL CONFIG
NOTE="gdumb_1r" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="gdumb"
...
if [ "$DATASET" == "cifar10" ]; then
    ...
    MODEL_NAME="resnet34" EVAL_PERIOD=200 F_PERIOD=20000
    BATCHSIZE=32; LR=0.05 OPT_NAME="sgd" SCHED_NAME="cos" MEMORY_EPOCH=255

elif [ "$DATASET" == "imagenet" ]; then
    MEM_SIZE=20000 ONLINE_ITER=0.25
    MODEL_NAME="resnet34" EVAL_PERIOD=2000 F_PERIOD=100000
