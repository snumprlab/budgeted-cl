...
# CIL CONFIG
NOTE="ewc_sigma10_cifar10_iter32" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="ewc++"
