...
class SparseTraining(object):
    def __init__(self, kwargs, model, logger=None, pre_defined_mask=None, seed=None):
        self.kwargs = kwargs
        ...
        self.gradient_masks = {}
        self.masked_layers = {}
        self.configs, self.prune_ratios = utils_pr.load_configs(model, kwargs["sp_config_file"], self.logger)
