...
# CIL CONFIG
NOTE="der_cifar100_total_constraint_iter3" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="der"
...
do
    CUDA_VISIBLE_DEVICES=1 nohup python main.py --mode $MODE --n_worker 3 \
    --dataset $DATASET \
