...
from models.bunny.language_model.minicpm.modeling_minicpm import MiniCPMModel, MiniCPMForCausalLM
from models.bunny.language_model.minicpm.configuration_minicpm import MiniCPMConfig
