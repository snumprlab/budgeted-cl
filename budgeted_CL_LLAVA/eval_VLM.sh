...
NOTE="Bongard-OpenWorld_ma_ver3_more_text_num5_iter0.5_infinite_base" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="VLM"
...
# --master_port 29500
CUDA_VISIBLE_DEVICES=0 python eval_VLM_CL.py \
